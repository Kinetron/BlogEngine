...
namespace GearShop.Services.Repository
{
    public class GearShopDbContext : DbContext//, IGearShopDbContext
    {
        ...
        {
           return this.Database.SqlQueryRaw<string>("select * from public.\"GetUserGroupRole\"(@user_name) as \"Value\"",
                new NpgsqlParameter("user_name", userName)).FirstOrDefault();
        }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Page>(entity =>
			{
				entity.ToTable(tb =>
				{
					tb.HasTrigger("pages_log_update");
					tb.HasTrigger("pages_log_insert");
				});
			});
		}
    }
